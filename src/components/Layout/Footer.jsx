      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-16 sm:py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3 pt-4">
              <div className="bg-slate-800/50 backdrop-blur-xl border border-violet-500/20 rounded-xl p-3 hover:border-violet-500/50 transition-colors">
                <div className="text-2xl font-bold bg-linear-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">50+</div>
                <div className="text-xs text-gray-400">Happy Clients</div>
              </div>
              <div className="bg-slate-800/50 backdrop-blur-xl border border-fuchsia-500/20 rounded-xl p-3 hover:border-fuchsia-500/50 transition-colors">
                <div className="text-2xl font-bold bg-linear-to-r from-fuchsia-400 to-indigo-400 bg-clip-text text-transparent">100+</div>
            ...
            <ul className="space-y-4 sm:space-y-4 text-gray-400 text-sm sm:text-base">
              <li>
                <a href="#" className="flex items-start gap-3 group hover:text-white transition-all hover:translate-x-1">
                  <div className="w-10 h-10 bg-slate-800/50 backdrop-blur-xl border border-indigo-500/20 rounded-lg flex items-center justify-center group-hover:border-indigo-500/50 group-hover:scale-110 transition-all">
              ...
              <li>
                <a href="mailto:hello@cloudgraphics.com" className="flex items-start gap-3 group hover:text-white transition-all hover:translate-x-1">
                  <div className="w-10 h-10 bg-slate-800/50 backdrop-blur-xl border border-violet-500/20 rounded-lg flex items-center justify-center group-hover:border-violet-500/50 group-hover:scale-110 transition-all">
                    <span className="text-lg">📧</span>
                  </div>
                  <div className="flex-1">
              ...
              <li>
                <a href="tel:+919876543210" className="flex items-start gap-3 group hover:text-white transition-all hover:translate-x-1">
                  <div className="w-10 h-10 bg-slate-800/50 backdrop-blur-xl border border-fuchsia-500/20 rounded-lg flex items-center justify-center group-hover:border-fuchsia-500/50 group-hover:scale-110 transition-all">
                    <span className="text-lg">📱</span>
                  </div>
                  <div className="flex-1">
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-gray-400 text-base sm:text-lg">Come say hello! We'd love to meet you in person 🤝</p>
          </div>

          <div className="relative group">
            {/* Decorative border with better animation */}
            <div className="absolute -inset-1 bg-linear-to-r from-violet-600 via-fuchsia-600 to-indigo-600 rounded-2xl sm:rounded-3xl blur-lg opacity-60 group-hover:opacity-100 transition duration-500 animate-pulse-slow"></div>
            
            {/* Map container */}
            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border border-violet-500/20">
              ...
              {/* Enhanced overlay info card */}
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-auto sm:max-w-md">
                <div className="bg-slate-900/95 backdrop-blur-2xl border border-violet-500/30 rounded-2xl p-5 sm:p-7 shadow-2xl hover:border-violet-500/50 transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-start gap-4">
                    <div className="shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-linear-to-br from-violet-500 via-fuchsia-500 to-indigo-500 rounded-2xl flex items-center justify-center text-2xl sm:text-3xl shadow-lg animate-float">
                      📍
                    </div>
                    <div className="flex-1">
                      <h4 className="font-bold text-lg sm:text-xl mb-1.5 bg-linear-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">Cloud Graphics</h4>
                      <p className="text-gray-400 text-sm sm:text-base mb-4">Amravati, Maharashtra, India</p>
                      <div className="flex flex-wrap gap-2">
                        <a 
                          href="https://maps.google.com/?q=Cloud+Graphics+Amravati" 
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-violet-600 to-fuchsia-600 rounded-lg text-white text-sm font-semibold hover:shadow-lg hover:shadow-violet-500/50 hover:scale-105 transition-all duration-300"
                        >
                        ...
                        <a 
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/80 backdrop-blur-xl border border-white/20 rounded-lg text-white text-sm font-semibold hover:border-violet-500/50 hover:scale-105 transition-all duration-300"
                        >
                          <span>📱</span>
                          <span>Call Now</span>
                        </a>
        ...
        <div className="border-t border-gray-800/50 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-6 text-gray-400 text-sm">
              ...
              <span className="text-gray-700">•</span>
              <a href="#" className="hover:text-white transition-colors hover:underline decoration-indigo-400">
                Cookie Policy
              </a>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/30 backdrop-blur-xl border border-violet-500/20 rounded-full text-xs text-gray-500 hover:border-violet-500/40 transition-colors">
              <span>✨</span>
              <span>This Website is Crafted with passion by</span>
              <span className="bg-linear-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent font-semibold">WebCultivate Team</span>
            </div>
          </div>
        </div>
      </div>
