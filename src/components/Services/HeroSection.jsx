      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Comprehensive creative solutions designed to elevate your brand and captivate your audience. From concept to execution, we've got you covered.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className="bg-slate-900/50 backdrop-blur-xl border border-violet-500/20 rounded-2xl p-6 text-center hover:border-violet-500/50 hover:scale-105 transition-all duration-300 group">
            <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">⭐</div>
            <div className="text-3xl md:text-4xl font-bold bg-linear-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent mb-2">98%</div>
