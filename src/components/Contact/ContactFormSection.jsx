...
const ContactFormSection = () => {
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-slate-950">
      <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-slate-900/50 backdrop-blur-xl border border-violet-500/20 p-6 sm:p-8 rounded-2xl">
        {/* Header */}
        <div className="text-center px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-linear-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">
            Contact Us
          </h2>
        ...
        <div className="grid lg:grid-cols-5 items-stretch gap-6 p-4 sm:p-6">
          ...
          <div className="lg:col-span-2 bg-linear-to-br from-violet-600/20 to-fuchsia-600/20 rounded-xl p-3 sm:p-4 lg:p-6 flex flex-col justify-center max-lg:order-1 relative overflow-hidden max-lg:mt-8 lg:mt-0 border border-violet-500/30">
            <div className="relative z-50">
              ...
              <p className="text-xs sm:text-sm lg:text-base text-gray-300 leading-relaxed mt-2 sm:mt-3 lg:mt-4">
                Have some big idea or brand to develop and need help?
              </p>
              ...
              <div className="mt-4 sm:mt-6 lg:mt-10">
                <ul className="space-y-3 sm:space-y-4 lg:space-y-6">
                  ...
                  <li className="flex items-center text-gray-300 hover:text-violet-400 transition-colors">
                    ...
                    <a
                      href="mailto:info@cloudgraphics.in"
                      className="text-sm sm:text-base ml-3 sm:ml-4"
                    >
                  ...
                  <li className="flex items-center text-gray-300 hover:text-violet-400 transition-colors">
                    ...
                    <span className="text-sm sm:text-base ml-3 sm:ml-4">
                      Near Sauji Dhaba Shivaji Complex Akoli Road Sai Nagar
                      Amravati 444607
                    </span>
                  </li>
                </ul>
                ...
                <ul className="flex flex-wrap gap-2 sm:gap-3 lg:gap-4 mt-4 sm:mt-6 lg:mt-10">
                  <li className="bg-violet-500/20 hover:bg-violet-500/40 h-8 w-8 sm:h-9 sm:w-9 lg:h-10 lg:w-10 rounded-full flex items-center justify-center shrink-0 transition-colors border border-violet-500/30">
                    <a href="#" aria-label="Facebook">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 fill-white"
                        viewBox="0 0 24 24"
                      >
                        <path
            ...
            {/* Decorative Circle */}
            <div className="absolute -bottom-16 sm:-bottom-24 -right-16 sm:-right-24 w-40 h-40 sm:w-60 sm:h-60 rounded-full bg-linear-to-br from-violet-600/30 to-fuchsia-600/30 blur-3xl"></div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="relative flex items-center w-full">
                  ...
                  <svg
                    ...
                    fill="#8b5cf6"
                    stroke="#8b5cf6"
                    className="w-3.5 h-3.5 sm:w-4 sm:h-4 absolute right-2"
                    viewBox="0 0 24 24"
                  >
                    <circle
                      cx="10"
                ...
                <div className="relative flex items-start col-span-full w-full">
                  ...
                  <svg
                    ...
                    fill="#8b5cf6"
                    stroke="#8b5cf6"
                    className="w-3.5 h-3.5 sm:w-4 sm:h-4 absolute right-2 top-2 sm:top-3"
                    viewBox="0 0 682.667 682.667"
                  >
                    <defs>
                ...
                <div className="col-span-full">
                  <h6 className="text-xs sm:text-sm md:text-base text-white font-medium">
                    Select Subject
                  </h6>
                  ...
                  <div className="flex flex-wrap gap-3 sm:gap-4 md:gap-6 mt-2 sm:mt-3">
                    {[
                      ...
                      { id: "card", label: "Business Card & Stationery" },
                      ...
                      <div key={item.id} className="flex items-center">
                        ...
                        <label
                          htmlFor={item.id}
                          className="relative p-0.5 flex items-center justify-center shrink-0
          peer-checked:before:hidden before:block before:absolute
          before:w-full before:h-full before:bg-slate-800
          w-4 h-4 sm:w-5 sm:h-5 cursor-pointer
          border-2 border-violet-500 rounded-full overflow-hidden"
                        >
                          <span className="border-3 sm:border-4 border-violet-500 rounded-full w-full h-full"></span>
                        </label>
                        <p className="text-[10px] sm:text-xs md:text-sm text-gray-300 ml-1.5 sm:ml-2">
                          {item.label}
                        </p>
                      </div>
                    ))}
