          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900/50 backdrop-blur-xl border border-violet-500/20 rounded-2xl p-6">
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="w-12 h-12 bg-linear-to-br from-violet-500 to-fuchsia-500 rounded-xl flex items-center justify-center hover:scale-110 hover:-rotate-6 transition-all duration-300 shadow-lg hover:shadow-violet-500/50"
                  aria-label="Facebook"
                >
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-linear-to-br from-pink-500 to-rose-500 rounded-xl flex items-center justify-center hover:scale-110 hover:rotate-6 transition-all duration-300 shadow-lg hover:shadow-pink-500/50"
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-linear-to-br from-blue-400 to-cyan-500 rounded-xl flex items-center justify-center hover:scale-110 hover:-rotate-6 transition-all duration-300 shadow-lg hover:shadow-blue-500/50"
                  aria-label="Twitter"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-linear-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center hover:scale-110 hover:rotate-6 transition-all duration-300 shadow-lg hover:shadow-indigo-500/50"
                  aria-label="LinkedIn"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
