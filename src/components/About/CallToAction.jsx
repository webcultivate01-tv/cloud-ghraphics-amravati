...
const CallToAction = () => {
  return (
    <section className="py-12 sm:py-16 lg:py-20 px-6 lg:px-12">
      <div className="max-w-4xl mx-auto text-center">
        <div className="relative">
          ...
          <div className="relative bg-slate-900/50 backdrop-blur-xl border border-violet-500/20 rounded-3xl p-6 sm:p-8 lg:p-12">
            ...
            <p className="text-gray-400 text-base sm:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto">
              Let's work together to bring your creative vision to life. We're excited to hear about your project!
            </p>
